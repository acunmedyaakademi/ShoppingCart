...
const Hero = () => {
  ...
  if (filteredProducts.length === 0) {
    productItems = <div>No products match your search.</div>;
  } else {
  ...
  return (
    <div>
      ...
      <ul className="portfolio-control">{filterItems}</ul>
      <div className="cardContainer">{productItems}</div>
      {isCartOpen && (
        <Cart data={products} cartItems={cartItems} onClose={toggleCart} />
      )}
    </div>
  );
};
